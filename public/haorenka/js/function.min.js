...
/*
 $("code").each(function(){
 $(this).html("<ul class='glutter'><li>" + $(this).html().replace(/\n/g,"\n</li><li>") +"\n</li></ul>");

 // $(this).html("<table><tbody><tr><td class=\"gutter\"><pre></pre><div class=\"line\">" + $(this).html().replace(/\n/g,"\n</li><li>") +"\n</div></td></td></tr></tbody></table>");
 });*/