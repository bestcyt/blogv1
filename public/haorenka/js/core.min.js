...
var searchTips = function() {
        $("#search_tips_drop").delegate("li", "click", function() {
            ...
            "" !== a.trim() && $.ajax({
                ...
                success: function(a) {
                    ...
                    } else $("#search_tips_drop").addClass("hide")
                }
            }), -1 != $("#search_input").val().indexOf("鑷潃") && $.message({
                message: "鍚湁鎮ㄦ鍦ㄦ悳绱㈢殑瀛楄瘝鎴栨爣绛剧殑淇℃伅锛岄€氬父浼氶紦鍚瑰彲鑳介€犳垚浼ゅ鐢氳嚦瀵艰嚧姝讳骸鐨勮涓恒€傚鏋滄偍鐩墠閬亣闅惧叧锛屾垜浠潪甯镐箰鎰�<a href='./'>浼稿嚭鎻存墜</a>銆�",
                title: "闇€瑕佸崗鍔╁悧锛�",
                type: "warning",
                autoHide: !1,
                time: "30000"
    ...
    function(a) {
        "use strict";
        a(function() {
            initTheme(), b(), m(), r(), a(".skPlayer-list-switch").bind("click", function() {
                player.toggleList()
        ...
        var b = function() {
                ...
                }), a('[data-toggle="tooltip"]').tooltip(), LocalConst.COMMENT_SYSTEM == LocalConst.COMMENT_SYSTEM_ROOT ? (n(), a(function() {
                        ...
                        success: function(k) {
                            ...
                            try {
                                ...
                                i = a(".comment-list", k).html().match(/id=\"?comment-\d+/g).join().match(/\d+/g).sort(function(a, b) {
                                    return a - b
                                }).pop(), a(".page-navigator .prev").length && "" == j && (i = ""), c("#success"), j ? (k = a("#comment-" + i, k).hide(), a("#" + j).find(".comment-children").length <= 0 && a("#" + j).append("<div class='comment-children list-unstyled m-l-xxl'><ol class='comment-list'></ol></div>"), i && a("#" + j + " .comment-children .comment-list").prepend(k), j = "") : (k = a("#comment-" + i, k).hide(), a(".comment-list").length || a("#comments").prepend('<h4 class="comments-title m-t-lg m-b special"> 0 鏉¤瘎璁�</h4><ol class="comment-list"></ol>'), a(".comment-list").prepend(k)), a("#comment-" + i).fadeIn();
                                var l;
                            ...
                            type: "warning"
                                ...
                                success: function(c) {
                                    ...
                                    try {
                                        ...
                                        alert("鎸変笅F12锛屾煡鐪嬭緭鍑洪敊璇俊鎭�"), console.log("error!\n" + a)
                                    }
                                }
                            }), !1)
                })
    ...
    }(jQuery), console.log("\n %c handsome v5.0 Pro %c by鍙嬩汉C | www.ihewro.com", "color:#444;background:#eee;padding:5px 0;", "color:#eee;background:#444;padding:5px 0;");