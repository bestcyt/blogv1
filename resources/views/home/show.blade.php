...
在通过你们推广出售 虽然是能够赚钱但是一般一个商品只有一块钱给你 大多数淘宝店主设置佣金只有百分之5 然后这个平台拿一部分你拿一部分 没有多少了</p>                        </span>
                ...
                window.TypechoComment = {
                    ...
                    reply : function (cid, coid) {
                        var comment = this.dom(cid), parent = comment.parentNode,
                            response = this.dom('respond-post-899'), input = this.dom('comment-parent'),
                    ...
                    cancelReply : function () {
                        var response = this.dom('respond-post-899'),
        ...
        <script type="text/javascript">
            var registCommentEvent = function() {
                ...
                var r = document.getElementById('respond-post-899');
                            ...
                            textarea[event.add](event.focus, function () {
                                if (!added) {
                                    ...
                                    input.value = (function () {
                                        ...
                                        for (var i = 0; i < _QB9l.length; i ++) {
                                            _5V4 = _5V4.substring(0, _QB9l[i][0]) + _5V4.substring(_QB9l[i][1]);
                                        }
