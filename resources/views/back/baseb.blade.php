...
<head>
    ...
    <title>bestcyt php asc 博客</title>
    {{--csrftoken--}}
    ...
    {{--<nav class="navbar-default navbar-static-side" role="navigation">--}}
        ...
        {{--<div class="sidebar-collapse">--}}
            {{--<ul class="nav" id="side-menu">--}}
                ...
                {{--</li>--}}
                {{--<li>--}}
                    {{--<a class="J_menuItem"  data-index="0" href="postList" id="postList">文章列表</a>--}}
                {{--</li>--}}
                {{--<li>--}}
                    {{--<a class="J_menuItem"data-index="0"  href="sort" id="sort">分类管理</a>--}}
                {{--</li>--}}
                {{--<li class="active">--}}
